...
})(["width:100%;padding:2rem 0 40px;box-sizing:content-box;background:#18191A;@media ", "{padding:0 16px 48px;width:calc(100vw - 32px);}"], function (props) {
